...
public class Registeration extends AppCompatActivity {
    ...
    String[] Pabna = {"Pabna Sadar","Ishwardi","Faridpur","Sathia","Sujanagar","Chatmohar","Bhangura","Atgharia","Aminpur","Banwarinagar","Bera","Debottar","Don't Know"};
    String[] Rajshahi = {"Bagha","Bagmara","Paba","Charghat","Durgapur","Godagari","Mohanpur","Puthia","Tanore","Rajpara","Boalia","Shah Mokhdum","Motihar","Don't Know"};
    String[] Kushtia = {"Kushtia Sadar","Kumarkhali","Khoksa","Mirpur","Bheramara","Daulatpur","Islamic University","Don't Know"};
    String[] Natore = {"Natore Sadar","Bagatipara","Singra","Boraigram","Gurudaspur","Lalpur","Don't Know"};
    String[] Dhaka = {"Adabor","Badda","Banani","Bangshal","Bimanbandar","Bsahantek","Cantonment","Chalkbazar","Dakhin Khan","Darus-Salam","Demra","Dhanmondi","Gandaria","Gulshan","Hazaribag","Jattrabari","Kafrul","Kalabagan","Kamrangirchar","Khilgaon","Khilkhet","Kodomtali","Kotwali","Lalbagh","Mirpur Model","Mohammadpur","Motijheel","Bagmara","Mugda","New Market","Pallabi","Paltan","Ramna Model","Rampura","Rupnagar","Sabujbag","Shah Ali","Shahbag","Shahjahanpur","Sutrapur","Shyampur","Sher-e-Bangla Nagar","Tejgaon Industrial Police","Tejgaon","Turag","Uttara East","Uttara West","Uttar Khan","Vatara","Wari","Don't Know"};
        ...
        try {
            ...
            statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (statee.equals("Pabna")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Pabna) {
                            list.add(text);
                        }
                    ...
                    if (statee.equals("Natore")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Natore) {
                            list.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, list);
                    ...
                    if (statee.equals("Kushtia")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Kushtia) {
                            list.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, list);
