...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    String chefid="6f52qbDE8RQmcc1LE4OtTAwsHQm2";
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            chefid ="6f52qbDE8RQmcc1LE4OtTAwsHQm2";// deliveryShipOrderss.getChefId();
                        ...
                        DatabaseReference data = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child("oCpc4SwLVFbKO0fPdtp4R6bmDmI3").child(randomuid).child("OtherInformation");
