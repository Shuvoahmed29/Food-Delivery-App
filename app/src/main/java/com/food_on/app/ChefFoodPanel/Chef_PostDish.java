        ...
        try {
            ...
            dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    State = chefc==null?"BD":chefc.getState();
                    City = chefc==null?"Dhaka":chefc.getCity();
                    Sub = chefc==null?"Mirpur":chefc.getSuburban();
                    ...
                    post_dish.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (isValid()) {
                                //uploadImage();
                                FoodSupplyDetails info = new FoodSupplyDetails(dishes, quantity, price, description, String.valueOf("no image"), RandomUId, ChefId);

                                Log.d("II_","Vaid "+info);

                                System.out.println("II_COM "+FirebaseAuth.getInstance().getCurrentUser().getUid()+" "+RandomUId);
